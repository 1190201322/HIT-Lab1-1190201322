...
public class DrawableTurtle implements Turtle {
    ...
    public void forward(int steps) {
        ...
        this.actionList.add(new Action(p2.P2.turtle.Action.ActionType.FORWARD, "forward " + steps + " steps", lineSeg));
    }
    ...
    public void turn(double degrees) {
        ...
        this.actionList.add(new Action(p2.P2.turtle.Action.ActionType.TURN, "turn " + degrees + " degrees", null));
    }

    public void color(PenColor color) {
        this.currentColor = color;
        this.actionList.add(new Action(p2.P2.turtle.Action.ActionType.COLOR, "change to " + color.toString().toLowerCase(), null));
    }
